...
from src.pororo.tasks import download_or_load
from src.pororo.tasks.utils.base import PororoFactoryBase, PororoSimpleBase
...
class PororoOcrFactory(PororoFactoryBase):
    ...
    def load(self, device: str):
        ...
        if self.config.n_model == "brainocr":
            from src.pororo.models.brainOCR import brainocr
